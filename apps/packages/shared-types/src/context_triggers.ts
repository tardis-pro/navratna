import { ContextualTrigger } from './persona_advanced';
...
export const contextualTriggers: Record<string, ContextualTrigger> = {
  'tech-lead': {
    conversationMoments: [
      ...
      'junior asking questions',
      'technical direction unclear',
    ],
    buildOnPatterns: [
