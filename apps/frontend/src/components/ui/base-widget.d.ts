...
export declare abstract class BaseWidgetComponent<P extends BaseWidgetProps = BaseWidgetProps, S = {}> extends Component<P, S & ErrorBoundaryState> implements WidgetLifecycle {
    private startTime;
...
export declare const withWidgetContext: <P extends object>(WrappedComponent: React.ComponentType<P & BaseWidgetProps>) => React.ForwardRefExoticComponent<React.PropsWithoutRef<P & BaseWidgetProps> & React.RefAttributes<any>>;
