    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="relative">
            <div className="w-16 h-16 bg-gradient-to-br from-purple-500 via-blue-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-xl shadow-purple-500/25">
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
            {/* Modal Header */}
            <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 p-4 sm:p-6 flex-shrink-0">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
                ...
                <div>
                  <label className="block text-base sm:text-lg font-semibold text-slate-900 dark:text-white mb-3 sm:mb-4">
                    Choose Provider Type
                  </label>
                  <p className="text-slate-600 dark:text-slate-400 text-sm mb-4 sm:mb-6">
                    ...
                    {providerTypes.map((type) => {
                      ...
                      return (
                        <button
                          ...
                          className={`group relative p-4 sm:p-6 border-2 rounded-xl text-left transition-all duration-300 transform hover:scale-[1.02] ${
                            isSelected
                ...
                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 sm:p-6 space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 sm:px-4 py-2 sm:py-3 border-2 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 text-base sm:text-lg ${
                        formErrors.name
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-slate-300 dark:border-slate-600 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 resize-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-3 sm:px-4 py-2 sm:py-3 pl-10 sm:pl-12 border-2 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 text-base sm:text-lg ${
                          formErrors.baseUrl
                            ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20'
                            : 'border-slate-300 dark:border-slate-600'
                        } bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400`}
                      />
                      <Globe className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-slate-400" />
                    </div>
                    {formErrors.baseUrl && (
                      <div className="flex items-center space-x-2 mt-2 text-red-600 dark:text-red-400">
                        <AlertCircle className="w-4 h-4" />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 sm:pr-12 border-2 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 text-base sm:text-lg font-mono ${
                            formErrors.apiKey
                              ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20'
                              : 'border-slate-300 dark:border-slate-600'
                          } bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400`}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-slate-300 dark:border-slate-600 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 sm:px-4 py-2 sm:py-3 border-2 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 ${
                          formErrors.priority
                            ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20'
                            : 'border-slate-300 dark:border-slate-600'
            ...
            <div className="flex-shrink-0 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex items-center space-x-3 order-1 sm:order-2">
                  <button
                    ...
                    className="flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 font-medium transition-colors duration-200 disabled:opacity-50 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    disabled={addingProvider}
                    className="flex-1 sm:flex-none flex items-center justify-center space-x-2 sm:space-x-3 px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                  >
                    {addingProvider && <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5 animate-spin" />}
                    <span className="text-sm sm:text-base">{addingProvider ? 'Creating...' : 'Create Provider'}</span>
                  </button>
                </div>
              </div>
            </div>
