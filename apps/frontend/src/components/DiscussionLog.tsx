          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              {hasParticipants ? (
                ...
                <span className="text-amber-600 dark:text-amber-400 text-sm">No participants</span>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              {hasDiscussion ? (
                ...
                <span className="text-slate-500 dark:text-slate-400 text-sm">Not started</span>
              )}
            </div>
          </div>
