    ...
    <Card className="h-full w-full overflow-hidden">
      <div style={rfWrapper}>
        ...
        >
          ...
          <Panel position="top-right" className="flex space-x-1 rounded-md bg-gray-800 p-2 shadow">
            <Button size="sm" variant="outline" onClick={handleAddNode} disabled={!selectedNode}>
              <Plus className="mr-1 h-4 w-4" />
              Add
            </Button>
            <Button size="sm" variant="outline" onClick={handleCopyNode} disabled={!selectedNode}>
              <Copy className="mr-1 h-4 w-4" />
              Copy
            </Button>
            <Button size="sm" variant="outline" onClick={handleEditNode} disabled={!selectedNode}>
