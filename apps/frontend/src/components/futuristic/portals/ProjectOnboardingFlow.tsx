          ...
          <>
            <div className="space-y-4">
              {selectedTools.map(toolId => {
                ...
                return (
                  <div key={toolId} className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50">
            ...
            {!isSetupInProgress && Object.keys(setupProgress).length === 0 && (
              <button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-200 font-medium shadow-lg shadow-blue-500/20"
              >
                Start Tool Setup
              </button>
            )}
    ...
    return (
      <div className="text-center space-y-6">
        ...
        <button
          ...
          className="w-full px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 font-medium shadow-lg shadow-green-500/20"
        >
          Open Project
        </button>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-xl z-50 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-slate-900/95 backdrop-blur-2xl rounded-2xl border border-slate-800/50 w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl shadow-black/20"
      >
        {/* Header */}
        ...
        {/* Footer */}
        <div className="p-8 border-t border-slate-800/50 flex items-center justify-between">
          <button
            onClick={handleBack}
