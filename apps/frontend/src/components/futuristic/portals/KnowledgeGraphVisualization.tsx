      ...
      <Card className="h-full w-full bg-black/20 border-red-500/20">
        <div className="p-8 text-center h-full flex items-center justify-center">
          <div>
            ...
            <Button onClick={handleRefresh} variant="outline" className="bg-red-600 hover:bg-red-700">
    ...
    <Card className={`h-full w-full overflow-hidden bg-black/20 border-blue-500/20 ${className}`}>
      <div style={rfWrapper}>
        ...
        >
          ...
          {/* Control Panel */}
          <Panel position='top-left' className='flex flex-col space-y-2 rounded-md bg-gray-800/90 p-3 shadow-lg backdrop-blur-sm'>
          ...
          {selectedNode && showDetails && (
            <Panel position='top-right' className='w-80 rounded-md bg-gray-800/95 p-4 shadow-lg backdrop-blur-sm'>
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <Badge
                    className="ml-2"
                    style={{
                      backgroundColor: KNOWLEDGE_NODE_STYLES[selectedNode.data.knowledgeType as keyof typeof KNOWLEDGE_NODE_STYLES]?.backgroundColor || '#64748b'
                    }}
                  >
