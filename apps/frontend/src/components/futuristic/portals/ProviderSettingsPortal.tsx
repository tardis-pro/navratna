...
export const ProviderSettingsPortal: React.FC<ProviderSettingsPortalProps> = ({ className, viewport }) => {
  ...
  const [userPreferences, setUserPreferences] = useState<Omit<UserLLMPreference, 'id' | 'userId' | 'createdAt' | 'updatedAt'>[]>([]);
  ...
  const updateUserPreference = (index: number, updates: Partial<Omit<UserLLMPreference, 'id' | 'userId' | 'createdAt' | 'updatedAt'>>) => {
    setUserPreferences(prev => prev.map((pref, i) => 
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400">Configure your default model preferences for different tasks</p>
                    </div>
                  </div>
                  <motion.button
                ...
                {loadingPreferences ? (
                  ...
                  <div className="text-center py-12 border-2 border-dashed border-slate-600/50 rounded-xl">
                    ...
                    <h3 className="text-lg font-medium text-slate-300 mb-2">No preferences configured</h3>
                    <p className="text-sm text-slate-500 mb-4">Add task-specific model preferences to optimize your AI experience</p>
                    <motion.button
                      onClick={addUserPreference}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => updateUserPreference(index, { taskType: e.target.value as LLMTaskType })}
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => updateUserPreference(index, { preferredProvider: e.target.value as LLMProviderType })}
                              className="w-full px-3 py-2 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                            >
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              <select
                                ...
                                onChange={(e) => updateUserPreference(index, { preferredModel: e.target.value })}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => updateUserPreference(index, { priority: parseInt(e.target.value) })}
                              className="w-full px-3 py-2 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => updateUserPreference(index, { 
                          ...
                          <div className="flex items-center">
                            <label className="flex items-center text-sm text-slate-300">
                              <input
                                ...
                                onChange={(e) => updateUserPreference(index, { isActive: e.target.checked })}
