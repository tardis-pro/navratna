    ...
    <div className={`p-6 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Document Context</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400">Upload and manage discussion documents</p>
          </div>
        </div>
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-16">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-slate-600 dark:text-slate-400 font-medium">Loading documents...</span>
          </div>
        </div>
      ) : (
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {Object.values(documents).length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 font-medium">No documents uploaded</p>
                  <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Upload a document to get started</p>
                </div>
              )}
            </div>
          </div>
              ...
              {activeDocument ? (
                <div className="p-6">
                  <div className="mb-4 pb-4 border-b border-slate-200 dark:border-slate-700">
                    <h4 className="font-medium text-slate-900 dark:text-white">{activeDocument.title}</h4>
                ...
                <div className="p-12 text-center">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 font-medium">No document selected</p>
                  <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Choose a document to view its content</p>
                </div>
              )}
            </div>
          </div>
