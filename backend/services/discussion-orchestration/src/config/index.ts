...
const loadConfig = (): DiscussionOrchestrationConfig => {
  const envConfig = {
    port: process.env.PORT
      ...
      : process.env.SERVICE_PORT
        ...
        : process.env.DISCUSSION_ORCHESTRATION_PORT
          ? parseInt(process.env.DISCUSSION_ORCHESTRATION_PORT)
          : undefined,
    ...
    websocket: {
      ...
      pingTimeout: process.env.WEBSOCKET_PING_TIMEOUT
        ? parseInt(process.env.WEBSOCKET_PING_TIMEOUT)
        : undefined,
      pingInterval: process.env.WEBSOCKET_PING_INTERVAL
        ? parseInt(process.env.WEBSOCKET_PING_INTERVAL)
        : undefined,
      maxConnections: process.env.WEBSOCKET_MAX_CONNECTIONS
        ? parseInt(process.env.WEBSOCKET_MAX_CONNECTIONS)
        : undefined,
      connectionTimeout: process.env.WEBSOCKET_CONNECTION_TIMEOUT
        ? parseInt(process.env.WEBSOCKET_CONNECTION_TIMEOUT)
        : undefined,
    },

    turnManagement: {
      defaultTimeout: process.env.TURN_DEFAULT_TIMEOUT
        ? parseInt(process.env.TURN_DEFAULT_TIMEOUT)
        : undefined,
      ...
      gracePeriod: process.env.TURN_GRACE_PERIOD
        ? parseInt(process.env.TURN_GRACE_PERIOD)
        : undefined,
      autoAdvance: process.env.TURN_AUTO_ADVANCE === 'true',
      notificationThreshold: process.env.TURN_NOTIFICATION_THRESHOLD
        ? parseInt(process.env.TURN_NOTIFICATION_THRESHOLD)
        : undefined,
    },
    ...
    limits: {
      maxParticipants: process.env.MAX_PARTICIPANTS
        ...
        : undefined,
      maxConcurrentDiscussions: process.env.MAX_CONCURRENT_DISCUSSIONS
        ? parseInt(process.env.MAX_CONCURRENT_DISCUSSIONS)
        : undefined,
      maxMessageLength: process.env.MAX_MESSAGE_LENGTH
        ? parseInt(process.env.MAX_MESSAGE_LENGTH)
        : undefined,
      maxMessagesPerMinute: process.env.MAX_MESSAGES_PER_MINUTE
        ? parseInt(process.env.MAX_MESSAGES_PER_MINUTE)
        : undefined,
      maxDiscussionDuration: process.env.MAX_DISCUSSION_DURATION
        ? parseInt(process.env.MAX_DISCUSSION_DURATION)
        : undefined,
    },
    ...
    realTime: {
      ...
      messageBufferSize: process.env.MESSAGE_BUFFER_SIZE
        ? parseInt(process.env.MESSAGE_BUFFER_SIZE)
        : undefined,
      presenceUpdateInterval: process.env.PRESENCE_UPDATE_INTERVAL
        ? parseInt(process.env.PRESENCE_UPDATE_INTERVAL)
        : undefined,
    },
    ...
    integrations: {
      agentIntelligence: {
        ...
        timeout: process.env.AGENT_INTELLIGENCE_TIMEOUT
          ? parseInt(process.env.AGENT_INTELLIGENCE_TIMEOUT)
          : undefined,
        retries: process.env.AGENT_INTELLIGENCE_RETRIES
          ? parseInt(process.env.AGENT_INTELLIGENCE_RETRIES)
          : undefined,
      },
      orchestrationPipeline: {
        baseUrl: process.env.ORCHESTRATION_PIPELINE_BASE_URL,
        timeout: process.env.ORCHESTRATION_PIPELINE_TIMEOUT
          ? parseInt(process.env.ORCHESTRATION_PIPELINE_TIMEOUT)
          : undefined,
        retries: process.env.ORCHESTRATION_PIPELINE_RETRIES
          ? parseInt(process.env.ORCHESTRATION_PIPELINE_RETRIES)
          : undefined,
      },
    },
    ...
    security: {
      ...
      websocketAuthTimeout: process.env.WEBSOCKET_AUTH_TIMEOUT
        ? parseInt(process.env.WEBSOCKET_AUTH_TIMEOUT)
        : undefined,
    },
  };
  ...
  const cleanConfig = JSON.parse(
    JSON.stringify(envConfig, (key, value) => (value === undefined ? undefined : value))
  );
