...
// Note: Other routes temporarily disabled for build
...
// Microservices temporarily disabled for build
// import {
//   AgentCoreService,
//   AgentContextService,
...
class AgentIntelligenceService extends BaseService {
  ...
  constructor() {
    ...
    // Controllers temporarily disabled for build
    ...
    // Microservices temporarily disabled
  ...
  protected async setupRoutes(): Promise<void> {
    ...
    // Other routes temporarily disabled for build
