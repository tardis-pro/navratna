...
// Import types - fix the import paths to use the correct module structure
import { 
  SecurityLevel, 
  AuditEventType,
  AgentRole,
...
// Import ToolSecurityLevel from entity
import { ToolSecurityLevel } from '../entities/toolDefinition.entity.js';

/**
 * Simple Database Seeding Script
 * Seeds core entities with realistic sample data
 */
  ...
  try {
    ...
    const tools = await toolRepository.save([
      ...
      },
      {
        ...
        examples: [
          {
            name: 'TypeScript API Generation',
            description: 'Generate REST API endpoints',
            parameters: {
              language: 'typescript',
              requirements: 'CRUD operations for user management'
            }
          }
        ],
    ...
    console.log('\n🔑 User Credentials:');
    console.log('   - admin@uaip.dev / admin123!');
    console.log('   - manager@uaip.dev / manager123!');
    console.log('   - analyst@uaip.dev / analyst123!');
    console.log('   - developer@uaip.dev / dev123!');
    console.log('   - guest@uaip.dev / guest123!');
