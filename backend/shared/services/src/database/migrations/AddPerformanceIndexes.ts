...
export class AddPerformanceIndexes1704592800000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_agent_model_provider" ON "agents" ("modelProvider")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_tool_security_level" ON "tool_definitions" ("securityLevel")`);

        // Tool execution indexes
        await queryRunner.query(`CREATE INDEX "IDX_tool_execution_tool_id" ON "tool_executions" ("toolId")`);
        await queryRunner.query(`CREATE INDEX "IDX_tool_execution_agent_id" ON "tool_executions" ("agentId")`);
        await queryRunner.query(`CREATE INDEX "IDX_tool_execution_user_id" ON "tool_executions" ("userId")`);
        await queryRunner.query(`CREATE INDEX "IDX_tool_execution_status" ON "tool_executions" ("status")`);
        await queryRunner.query(`CREATE INDEX "IDX_tool_execution_started_at" ON "tool_executions" ("startedAt")`);

        // Discussion indexes
        await queryRunner.query(`CREATE INDEX "IDX_discussion_status" ON "discussions" ("status")`);
        await queryRunner.query(`CREATE INDEX "IDX_discussion_created_at" ON "discussions" ("createdAt")`);
        await queryRunner.query(`CREATE INDEX "IDX_discussion_moderator_id" ON "discussions" ("moderatorId")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_operation_created_at" ON "operations" ("createdAt")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_audit_event_resource_type" ON "audit_events" ("resourceType")`);
        await queryRunner.query(`CREATE INDEX "IDX_audit_event_resource_id" ON "audit_events" ("resourceId")`);
        await queryRunner.query(`CREATE INDEX "IDX_audit_event_timestamp" ON "audit_events" ("timestamp")`);

        // Approval workflow indexes
        await queryRunner.query(`CREATE INDEX "IDX_approval_workflow_status" ON "approval_workflows" ("status")`);
        await queryRunner.query(`CREATE INDEX "IDX_approval_workflow_requester_id" ON "approval_workflows" ("requesterId")`);
        await queryRunner.query(`CREATE INDEX "IDX_approval_workflow_created_at" ON "approval_workflows" ("createdAt")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_refresh_token_user_id" ON "refresh_tokens" ("userId")`);
        await queryRunner.query(`CREATE INDEX "IDX_refresh_token_expires_at" ON "refresh_tokens" ("expiresAt")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_project_member_project_id" ON "project_members" ("projectId")`);
        await queryRunner.query(`CREATE INDEX "IDX_project_member_user_id" ON "project_members" ("userId")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_tool_category_active" ON "tool_definitions" ("category", "isActive")`);
        await queryRunner.query(`CREATE INDEX "IDX_audit_user_timestamp" ON "audit_events" ("userId", "timestamp")`);
        await queryRunner.query(`CREATE INDEX "IDX_project_owner_status" ON "projects" ("ownerId", "status")`);
    }
