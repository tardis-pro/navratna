/**
 * @deprecated This file has been refactored into multiple seeder files.
 * Use the new seeder structure in ./seeders/ directory instead.
 *
 * Import the new seedDatabase function from ./seeders/index.js
 */
